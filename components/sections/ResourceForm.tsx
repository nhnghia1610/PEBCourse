  ...
  return (
    <>
      <div className="flex gap-2 items-center text-xl font-bold mt-12">
        <PlusCircle />
        Tài liệu học tập (không bắt buộc)
      </div>
      ...
      <div className="mt-5 flex flex-col gap-5">
        {section.resources.map((resource) => (
          <div key={resource.id} className="flex justify-between bg-gray-100 rounded-lg text-sm font-medium p-3">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="vd. Tài liệu tham khảo" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  <FormLabel>Tải tập tin</FormLabel>
                  <FormControl>
                    <FileUpload
                      value={field.value || ""}
